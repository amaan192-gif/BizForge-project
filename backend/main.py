...
from ai_services import generate_brand_details, generate_logo, generate_marketing_content, generate_design_system
...
# Assuming backend/main.py is running, frontend is level with backend
app.mount("/static", StaticFiles(directory="../frontend/static"), name="static")

# Configure templates for the frontend directory
